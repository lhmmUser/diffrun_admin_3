...
export default function Home() {
  const baseUrl = "https://420c-14-142-182-243.ngrok-free.app";
  ...
  const buildOrdersUrl = (r: RangeKey) => {
    ...
    return `https://420c-14-142-182-243.ngrok-free.app/stats/orders?${params.toString()}`;
  };
  ...
  const buildRevenueUrl = (r: RangeKey) => {
    ...
    return `https://420c-14-142-182-243.ngrok-free.app/stats/revenue?${params.toString()}`;
  };
