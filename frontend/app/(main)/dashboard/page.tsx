...
export default function Home() {
  const baseUrl = "https://a5d0-14-142-182-243.ngrok-free.app";
  ...
  const buildOrdersUrl = (r: RangeKey) => {
    ...
    return `https://a5d0-14-142-182-243.ngrok-free.app/stats/orders?${params.toString()}`;
  };
  ...
  const buildRevenueUrl = (r: RangeKey) => {
    ...
    return `https://a5d0-14-142-182-243.ngrok-free.app/stats/revenue?${params.toString()}`;
  };
